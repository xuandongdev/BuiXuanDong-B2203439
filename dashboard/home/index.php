...
<div class="container">
        <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light"
            ...
            <a class="navbar-brand" href="./index.php">
                <img src="https://navigates.vn/wp-content/uploads/2023/03/ctu.jpg"
                    alt="quanlynhathuocCTU.com" width="60px" height="auto" />
            </a>
            ...
            <div class="collapse navbar-collapse ml-100" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-item nav-link active" href="../../product/drugstore/drugstore.php">Nhà thuốc
                            online</a>
                    </li>
                </ul>
    ...
    <img src="https://events.ctu.edu.vn/images/sampledata/1-20210309_104552_hgpl.jpg" class="w3-image w3-greyscale-min" style="width: 100%; height: min-content;" />
    <footer>
        <div class="container d-flex flex-wrap p-5 ">
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div>
                    ...
                    <a href="#">Privacy Policy</a><b>DHCT@email.com</b>
                    <p>Mon to Fri : 08:30 - 18:00</p>
                    <a href="#"><b><i class="fas fa-phone pr-1"></i>+03-456-6588</b></a>
                </div>
            </div>
        </div>
        </div>
